module.exports = class Data1685269976985 {
    name = 'Data1685269976985'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "token" ("id" character varying NOT NULL, "token_id" integer NOT NULL, "uri" text, "attributes" jsonb, "owner_id" character varying, CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`)
